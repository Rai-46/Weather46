...
class ContentViewModel: ObservableObject {
    ...
    func getWeather(kenmei: String){
        ...
        //URLの読み込み
        let currentConverter = CurrentRequest(urlString: "https://api.openweathermap.org/data/2.5/weather?q=\(kenmei_encode)&appid=b36d2c7d5713d2b3af8919622aa36351&lang=ja&units=metric")
    ...
    func getForcast(lon: Double, lat: Double){
        ...
        let forcastConverter = CurrentRequest(urlString: "https://api.openweathermap.org/data/2.5/onecall?lat=\(lat)&lon=\(lon)&appid=b36d2c7d5713d2b3af8919622aa36351&lang&units=metric")
